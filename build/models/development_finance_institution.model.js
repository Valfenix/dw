...
var dfiSchema = new mongoose_1.Schema({
    longitude: Number,
    latitude: Number,
    category: String,
    state: {
...
exports.default = mongoose_1.default.model('DevelopmentFinanceInstitution', dfiSchema);
//# sourceMappingURL=development_finance_institution.model.js.map